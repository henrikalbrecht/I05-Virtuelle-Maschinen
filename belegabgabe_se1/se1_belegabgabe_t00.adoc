...
= Technische Spezifikation
* Vision
* Use Case Model (inkl. Wireframes)
...
* Projektplan
* Risikoliste
* Iterationspläne (für Iterationen 2 und 3)

:imagesdir: {docs-project-management}/images

// Verantwortlichkeiten
include::{docs-project-management}/responsibilities.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
