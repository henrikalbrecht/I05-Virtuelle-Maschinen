...
Das System wird ausschließlich von einer Person verwendet, jedoch kann sich diese und die von ihr verwendeten Endgeräte ändern. Daher wird die Anwendung in Form eines Docker Containers zur Verfügung gestellt. Damit garantieren wir eine möglichst kompatible Auslieferung welche auf einer Vielzahl unterschiedlicher Systeme verwendet werden kann.

== Annahmen und Abhängigkeiten
//[List the assumptions and dependencies that drive architectural decisions. This could include sensitive or critical areas, dependencies on legacy interfaces, the skill and experience of the team, the availability of important resources, and so forth]
Annahmen:

* Der Nutzer ist im internen Netz der HTW Dresden.
...
. Wir nutzen NextJs als Frontend Framework, da es weitverbreitet ist und somit die Wahrscheinlichkeit auf langfristigen Support höher.

. Wir nutzen Objekt relationale Mapper um die Daten der Datenbank auf die objektorientierten Daten unserer Software zu mappen.
