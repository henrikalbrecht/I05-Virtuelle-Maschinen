...
- _Klasse_ Anmeldedaten:: Diese Klasse speichert die Zusammensetzung von Benutzername und Passwort. Die gültige Emailadresse muss das `@`-Zeichen und einen `.` Punkt enthalten. Alias: Login.
