...
| IP | Das Internet Protocol ist ein grundlegendes Kommunikationsprotokoll, das die Übertragung von Datenpaketen in Computernetzwerken ermöglicht. | Internet Protocol
| IPv4 | IPv4 steht für Internet Protocol Version 4 und ist eine der Hauptversionen des Internet Protocol (IP), das für die Adressierung und den Routing von Datenpaketen im Internet verwendet wird. | Internet Protocol Version 4
