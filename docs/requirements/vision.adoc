...
==== VM Verwalter
* Es gibt einen VM Verwalter und er ist der einzige Nutzer des Systems.
* Er verwaltet die VMs, welche an Beleggruppen vergeben wurden.
* Zur Kommunikation mit Studenten und Laborbereich wird der E-Mail Verkehr verwendet.
