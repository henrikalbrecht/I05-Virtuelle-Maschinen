...
==== VM Administrator
* Es gibt einen VM Administrator und er ist der einzige Nutzer des Systems. Er ist jedoch abhängig von der Zuarbeit des Rechenzentrums der Hochschule.
* Der VM Administrator verwendet den Browser eines PC um die Verwaltung vorzunehmen.
