...
| Auftraggeber/Admin
| Die Person, welches für die Vergabe der virtuellen Maschinen zuständig ist und zu der Verwaltung Zugang hat.
| * Anlegen, Bearbeiten, Löschen und Anzeigen von VMs
* Verwaltung der Konfigkurationsmöglichkeiten
* Verwaltung von E-Mail-Templates für die Vergabe und Kommunikation mit den Studierenden und dem Laborbereich Informatik
* Zuweisung von VMs an Studierende

| Softwareentwicklungsteam
| Personen, die für die Entwicklung des Systems zuständig sind.
| 
* Umsetzung der technischen und organisatorischen Anforderungen
* Sicherstellung der Qualität, Benutzerfreundlichkeit und Zuverlässigkeit des Systems
* Dokumentation des Systems
* Implementierung von Funktionen der Verwaltung

| Rechenzentrum der HTW Dresden
...
|Modifizieren der VM | hoch | Die Eigenschaften jeder VM muss individuell verändert werden können | xx
