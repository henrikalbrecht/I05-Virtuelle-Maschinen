...
Begonnen haben wir damit, als wir die Rollen innerhalb des Teams auf Grundlage der Wünsche jedes Einzelnen verteilt haben.  Weiterhin veranstalten wir regelmäßige *Teamevents*. Um den Wissensstand innerhalb des Teams so gleichmäßig wie möglich zu halten, halten wir Workshops, beispielsweise für GitHub, um jeden Einzelnen an die Funktionalitäten heranzuführen und das Wissen zu streuen. Die Erkenntnisse der Workshops werden außerdem im https://github.com/henrikalbrecht/I05-Virtuelle-Maschinen/wiki[Wiki] zusammengetragen.
