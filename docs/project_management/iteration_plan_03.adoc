...
[%header, cols="3,1"]
siehe Projektplan, xref:project_plan.adoc#Meilensteine und Ziele[Meilensteine und Ziele]
...
| Git Workflow | fixed | Um die Arbeit an einzelnen Funktionalitäten in den Pull requests besser unterscheiden zu können, ist eine Arbeit mit branches notwendig. Die Arbeit mit branches muss bei einem weiteren Workshop während eines Team meetings vermittelt werden.

| Nutzung von Google Docs | open | Für die Erstellung des Glossars wurde durch die Verantwortlichen ein Google Docs Dokument angelegt, was Mehrarbeit zur Folge hat, da die Daten im Anschluss in das entsprechende Dokument auf Github überführt werden müssen. Es gilt Einigung darüber zu erreichen, dass Arbeit direkt über die Entwicklungsumgebung an den Github-Dokumenten durchgeführt wird, um effizient zu bleiben.

| Statusaktualisierung Github Issues | open | Die in Git angelegten Issues, welche die Verteilung der Aufgaben an alle Teammitglieder darstellt, sind dafür vorgesehen, von dem entsprechenden Bearbeiter in den Status "In progress" gesetzt zu werden, sobald die Arbeit daran beginnt. Diese Regel wird aktuell ungenügend beachtet und muss in einem zukünftigen Team-Meeting erneut vermittelt werden.
|===
...
* Workshop für Developer und Tester wurden inkl. Erfolgskontrolle durchgeführt
...
[%header, cols="1,3"]
|===
| Assessment Ziel | Problemlösung zu __Aufgabenverteilung__
...
[%header, cols="1,3"]
|===
| Assessment Ziel | Problemlösung zu __Git Workflow__
...
** Use-Case 01 liegt vollständig vor **(Y/N)**
** Use-Case 03 liegt vollständig vor **(Y/N)**
** Probleme aus Iteration 02 wurden adressiert und behoben **(Y)**
** Risikoliste wurde mit mindestens 5 Risiken erarbeitet **(Y/N)**
...
| Assessment Datum | 18.12.2023
| Teilnehmer | {project-team-name}
| Projektstatus: *grün* | //TODO: Retro durchführen
|===
